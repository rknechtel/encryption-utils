 ...
 *********************************************************/
  ...
  public boolean isValidPassword(String password)
  {
    ...
    if (result)
    {
      ...
      String nonAlpha = "1234567890~!@#$%^&*()-_=+";

      for (int i = 0; i < password.length(); i++)
      {
        if (0 <= nonAlpha.indexOf(password.charAt(i)))
        {
          result = true;
  ...
  public String getValidPasswordDescription()
  {
    StringBuffer sb = new StringBuffer();
    sb.append("Passwords must be at least six (6) characters ");
    sb.append("and contain at least one non-alphabetic character");

    return (sb.toString());
  }
  
} // End of Class MD5EncryptionUtils

 ...
 *  Name                  Date          Comments
 *  -------------------------------------------------------------------------------
 *  Jeffrey M. Hunter              1998-2011        Created
 * </pre>
 * 
 **********************************************************************************/
package com.rk.encryptionutils.thirdparty;
...
public class StringEncrypter
{
  ...
  /**
   * Constructor used to create this object. Responsible for setting and initializing this object's encrypter and decrypter Chipher instances given a Secret Key
   * and algorithm.
   * 
   * @param key
  ...
  /**
   * The following method is used for testing the String Encrypter class. This method is responsible for encrypting and decrypting a sample String using several
   * symmetric temporary Secret Keys.
   */
  ...
  /**
   * The following method is used for testing the String Encrypter class. This method is responsible for encrypting and decrypting a sample String using using a
   * Pass Phrase.
   */
